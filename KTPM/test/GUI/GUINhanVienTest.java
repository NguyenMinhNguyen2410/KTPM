 ...
 * @author nguye
 */
public class GUINhanVienTest {
    private GUINhanVien instance;
    public GUINhanVienTest() throws Exception {
        NhanVienBUS.docDB();
        instance=new GUINhanVien();
    }
    @Test
    ...
    public void testcaseID_10(){
        ...
        String[] expected={"Mã nhân viên", "Họ", "Tên", "Gmail", "Giới tính", "SĐT", "Tổng chi tiêu"};
    ...
    public void testcaseID_14(){
        instance.getThem().doClick();
      boolean check=instance.getTxt_NhanVien_Them()[0].isEditable();
      instance.getThoat().doClick();
    ...
    public void testcaseID_15(){
        ...
        instance.getTxt_NhanVien_Sua()[1].setText(text);
        SwingUtilities.invokeLater(new Runnable(){
            @Override
            public void run(){
                String expected="Họ nhân viên không được quá 50 ký tự";
    ...
    public void testcaseID_18(){
        ...
        instance.getTable().tb.setRowSelectionInterval(0, 0);
        instance.getSua().doClick();
        instance.getTxt_NhanVien_Sua()[2].setText(text);
        SwingUtilities.invokeLater(new Runnable(){
            @Override
            public void run(){
                String expected="Tên nhân viên không được quá 50 ký tự";
                instance.getLuu().doClick();
               instance.getOp().setOptionType(JOptionPane.YES_OPTION);
               assertTrue("Sai thông điệp",instance.getOp().getMessage().equals(expected));
               instance.getOp().setOptionType(JOptionPane.OK_OPTION);
    ...
    public void testcaseID_19(){
        ...
        SwingUtilities.invokeLater(new Runnable(){
            @Override
            public void run(){
                String expected="Tên nhân viên không được chưa ký tự đặc biệt";
                instance.getLuu().doClick();
               instance.getOp().setOptionType(JOptionPane.YES_OPTION);
               assertTrue("Sai thông điệp",instance.getOp().getMessage().equals(expected));
               instance.getOp().setOptionType(JOptionPane.OK_OPTION);
    ...
    public void testcaseID_21(){
        ...
        instance.getTable().tb.setRowSelectionInterval(0, 0);
        instance.getSua().doClick();
        instance.getTxt_NhanVien_Sua()[5].setText(text);
        SwingUtilities.invokeLater(new Runnable(){
            @Override
            public void run(){
    ...
    public void testcaseID_25(){
        ...
        instance.getTable().tb.setRowSelectionInterval(0, 0);
        instance.getSua().doClick();
        instance.getTxt_NhanVien_Sua()[3].setText(text);
        SwingUtilities.invokeLater(new Runnable(){
            @Override
            public void run(){
    ...
    public void testcaseID_30(){
        instance.getTable().tb.setRowSelectionInterval(0, 0);
        instance.getSua().doClick();
        instance.getTxt_NhanVien_Sua()[1].setText("");
        SwingUtilities.invokeLater(new Runnable(){
            @Override
            public void run(){
